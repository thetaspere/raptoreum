...
# TestP2PConn: A peer we use to send messages to thetad, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes thetad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that thetad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for thetad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # thetad will not send blocktxn responses for blocks whose height is
