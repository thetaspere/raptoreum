...
official/supported Docker Images found at https://hub.docker.com/r/theta/thetad/
...
**NOTE: Please update the image description at https://hub.docker.com/r/theta/thetad-develop/ when changing the above text**