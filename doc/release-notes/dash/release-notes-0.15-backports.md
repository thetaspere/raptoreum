...
- [`595826ad6`](https://github.com/theta/theta/commit/595826ad6) Merge #12549: Make prevector::resize() and other prevector operations much faster
...
- [`b451094e2`](https://github.com/theta/theta/commit/b451094e2) Merge #11490: Disconnect from outbound peers with bad headers chains
...
- [`9a5b798e9`](https://github.com/theta/theta/commit/9a5b798e9) Merge #10957: Avoid returning a BIP9Stats object with uninitialized values
...
- [`74325db11`](https://github.com/theta/theta/commit/74325db11) Merge #10859: RPC: gettxout: Slightly improve doc and tests
...
- [`9f71ab04b`](https://github.com/theta/theta/commit/9f71ab04b) remove chainparams from method call (10758)
...
- [`c62c7ab6d`](https://github.com/theta/theta/commit/c62c7ab6d) Merge #10662: Initialize randomness in benchmarks
...
- [`c2fcf849a`](https://github.com/theta/theta/commit/c2fcf849a) Merge #11025: qa: Fix inv race in example_test
...
- [`7f1009ed5`](https://github.com/theta/theta/commit/7f1009ed5) Merge #11023: [tests] Add option to attach a python debugger if functional test fails
...
- [`ab1120956`](https://github.com/theta/theta/commit/ab1120956) Merge #10844: Use range based for loop
...
- [`ec01825ba`](https://github.com/theta/theta/commit/ec01825ba) Merge #10786: Add PR description to merge commit in github-merge.py
...
- [`f68c7bc5c`](https://github.com/theta/theta/commit/f68c7bc5c) Merge #10626: doc: Remove outdated minrelaytxfee comment
...
- [`e81a28604`](https://github.com/theta/theta/commit/e81a28604) scripted-diff: Remove PAIRTYPE #10502
...
- [`6c0b5053b`](https://github.com/theta/theta/commit/6c0b5053b) Fix start_/stop_node-s
...
- [`bb370afbf`](https://github.com/theta/theta/commit/bb370afbf) s/bitcoin/theta
...
- [`7918cae2f`](https://github.com/theta/theta/commit/7918cae2f) Merge #10383: [logging] log system time and mock time
...
- [`15f7f9c85`](https://github.com/theta/theta/commit/15f7f9c85) Merge #10287: [tests] Update Unit Test for addrman.h/addrman.cpp
...
- [`717e0957e`](https://github.com/theta/theta/commit/717e0957e) Merge #10292: Improved efficiency in COutPoint constructors
...
- [`81afb1058`](https://github.com/theta/theta/commit/81afb1058) remove `nodehandling.py`
...
- [`55d1251ff`](https://github.com/theta/theta/commit/55d1251ff) Merge #9480: De-duplicate SignatureCacheHasher
...
- [`2f63322cd`](https://github.com/theta/theta/commit/2f63322cd) thetaify "Finding reviewers" section to be more relevant
...
- [`818ec218d`](https://github.com/theta/theta/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/theta/theta/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/theta/theta/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/theta/theta/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/theta/theta/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/theta/theta/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/theta/theta/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/theta/theta/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/theta/theta/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/theta/theta/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/theta/theta/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/theta/theta/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/theta/theta/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/theta/theta/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/theta/theta/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/theta/theta/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/theta/theta/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/theta/theta/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/theta/theta/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/theta/theta/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/theta/theta/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/theta/theta/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/theta/theta/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/theta/theta/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/theta/theta/commit/1cfda206a) Merge #9993: Initialize nRelockTime
