...
* theta.conf: contains configuration settings for thetad or theta-qt
* thetad.pid: stores the process id of thetad while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by thetad or theta-qt
