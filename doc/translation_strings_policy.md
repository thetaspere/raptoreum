...
This document provides guidelines for internationalization of the Theta Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `theta_en.ts` remains unchanged.
