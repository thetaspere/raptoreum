...
* Update translations, see [translation_process.md](https://github.com/thetaspere/theta/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/thetaspere/theta/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/thetaspere/theta.git
...
space *do not upload these to the thetaspere.com server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the thetaspere.com server

- Update thetaspere.com

- Announce the release:

  - Optionally Discord, twitter, reddit /r/Thetaspere, ... but this will usually sort out itself
  ...
  - Create a [new GitHub release](https://github.com/thetaspere/theta/releases/new) with a link to the archived release notes.
