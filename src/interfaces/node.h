...
//! Interface for the src/evo part of a theta node (thetad process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a theta node (thetad process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a theta node (thetad process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a theta node (thetad process).
class Node
{
public:
    virtual ~Node() {}
