...
/* ThetaGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* ThetaGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_APP_NAME_REGTEST "Theta-Qt-regtest"
