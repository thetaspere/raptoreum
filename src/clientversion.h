...
#error Client version information missing: version is not defined by theta-config.h or in any other way
#endif
...
/**
 * thetad-res.rc includes this file, but it cannot cope with real c++ code.
